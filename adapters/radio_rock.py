        ...
        while self.running:
            try:
                ...
                if resp.status_code == 200:
                    ...
                    log(f"Chyba HTTP song: {resp.status_code}")
            except Exception as e:
                log(f"Chyba song poll: {e}")
    ...
    def upload_periodically(self):
        while self.running:
            try:
                ...
                log("Dáta boli odoslané do Cloudflare R2.")
            except Exception as e:
                log(f"Chyba pri uploade do Cloudflare: {e}")
